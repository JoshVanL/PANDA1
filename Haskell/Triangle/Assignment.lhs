...
* [Extension.html](Extension.html) ([source](Extension.lhs))

***
**Done:**
Please submit your `Triangle.lhs`, `Extension.lhs`, and `Extension.pdf` via SAFE.
...
Task                      Marks
-----                     ------
Triangle.lhs: tests       40%
Triangle.lhs: ex1         5%
Triangle.lhs: ex2         5%
Triangle.lhs: ex3         5%
Extension.lhs: extension  45%
...
***
**Done:** Download [Assignment.lhs](Assignment.lhs) and open it in
